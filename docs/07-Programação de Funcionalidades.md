...
|RF-004| Editar informações do perfil do usuário. | Views/Usuarios/Perfil, Controllers/Usuarios, Models/Usuario | João Paulo |
...
|RF-013| Personalizar as preferências da aplicação (idioma, tema claro/escuro e notificações). | Views/Usuarios/Configuracoes, Controllers/Usuarios, Models/Usuario | João Paulo |
